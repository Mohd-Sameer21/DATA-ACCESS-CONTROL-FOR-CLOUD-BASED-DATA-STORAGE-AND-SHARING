...
String query="SELECT * FROM reqkey WHERE touser='"+to+"';";
...
%>
    <tr><td><%=rs.getString("fromuser") %></td>
  <td><%=rs.getString("fileName") %></td>
  <td><a href="keysend.jsp?from=<%=rs.getString("fromuser") %>&fileName=<%=rs.getString("fileName") %>">Click here</a></td> </tr>
  </tr>
        <%

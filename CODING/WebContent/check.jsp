      ...
      <br/>
		...
		<table border="1" align="center" bgcolor="#adf156">
			<tr>
				...
				<td style="font-size: 20px">Select the table name to move</td>
	...
	%>
		<table border="1" align="center" bgcolor="<%=clr %>">
			<tr>
				...
				<td style="color: red;font-size: 20px;">File Name</td>
				<td style="color: red;font-size: 20px;">File Size</td>
				<td style="color: red;font-size: 20px;">File Path</td>
				<td style="color: red;font-size: 20px;">Key</td>
				<td style="color: red;font-size: 20px;">User</td>
				<td style="color: red;font-size: 20px;">Select</td>

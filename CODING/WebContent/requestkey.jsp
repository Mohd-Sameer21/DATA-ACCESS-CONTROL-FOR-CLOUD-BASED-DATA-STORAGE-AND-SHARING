...
<form action="reqkey" method="post">
<pre>
 Sending Request From	:	<input type="text" name="from" value="<%= ReciverName%>" readonly="readonly"><br/>
 
 File Name		:	<input type="text" name="fname"/> <br/>
 
 Sending Request To	:	<input type="text" name="to" ><br/>
